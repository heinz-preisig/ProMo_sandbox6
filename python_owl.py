...
# 192
label = variables[192]["label"]
network = variables[192]["network"]
variable_type = variables[192]["type"]
label = variables[192]["label"]
doc = variables[192]["doc"]
onto_ID = "V_192"
V_192 = onto.ProMoVar( onto_ID )
V_192.label = label
V_192.network = network
V_192.variable_type = variable_type
V_192.comment = doc

units = variables[192]["units"].asList()
V_192.time = [ units[0] ]
V_192.length = [ units[1] ]
V_192.amount = [ units[2] ]
V_192.mass = [ units[3] ]
V_192.temperature = [ units[4] ]
V_192.current = [ units[5] ]
V_192.light = [ units[6] ]

# 193
label = variables[193]["label"]
network = variables[193]["network"]
variable_type = variables[193]["type"]
label = variables[193]["label"]
doc = variables[193]["doc"]
onto_ID = "V_193"
V_193 = onto.ProMoVar( onto_ID )
V_193.label = label
V_193.network = network
V_193.variable_type = variable_type
V_193.comment = doc

units = variables[193]["units"].asList()
V_193.time = [ units[0] ]
V_193.length = [ units[1] ]
V_193.amount = [ units[2] ]
V_193.mass = [ units[3] ]
V_193.temperature = [ units[4] ]
V_193.current = [ units[5] ]
V_193.light = [ units[6] ]

# 194
label = variables[194]["label"]
network = variables[194]["network"]
variable_type = variables[194]["type"]
label = variables[194]["label"]
doc = variables[194]["doc"]
onto_ID = "V_194"
V_194 = onto.ProMoVar( onto_ID )
V_194.label = label
V_194.network = network
V_194.variable_type = variable_type
V_194.comment = doc

units = variables[194]["units"].asList()
V_194.time = [ units[0] ]
V_194.length = [ units[1] ]
V_194.amount = [ units[2] ]
V_194.mass = [ units[3] ]
V_194.temperature = [ units[4] ]
V_194.current = [ units[5] ]
V_194.light = [ units[6] ]

# 195
label = variables[195]["label"]
network = variables[195]["network"]
variable_type = variables[195]["type"]
label = variables[195]["label"]
doc = variables[195]["doc"]
onto_ID = "V_195"
V_195 = onto.ProMoVar( onto_ID )
V_195.label = label
V_195.network = network
V_195.variable_type = variable_type
V_195.comment = doc

units = variables[195]["units"].asList()
V_195.time = [ units[0] ]
V_195.length = [ units[1] ]
V_195.amount = [ units[2] ]
V_195.mass = [ units[3] ]
V_195.temperature = [ units[4] ]
V_195.current = [ units[5] ]
V_195.light = [ units[6] ]
...
incidence_list.append( V_11 )
F_ID = "F_156"
F_156 = onto.function( F_ID )
F_156.is_function_of = incidence_list
V_160.has_function.append( F_156 )
incidence_list = []
...
V_160.has_function.append( F_177 )
incidence_list = []
...
V_160.has_function.append( F_182 )
#161
...
incidence_list.append( V_6 )
F_ID = "F_168"
F_168 = onto.function( F_ID )
F_168.is_function_of = incidence_list
V_173.has_function.append( F_168 )
incidence_list = []
incidence_list.append( V_182 )
incidence_list.append( V_160 )
F_ID = "F_196"
F_196 = onto.function( F_ID )
F_196.is_function_of = incidence_list
V_173.has_function.append( F_196 )
incidence_list = []
incidence_list.append( V_170 )
incidence_list.append( V_187 )
F_ID = "F_197"
F_197 = onto.function( F_ID )
F_197.is_function_of = incidence_list
V_173.has_function.append( F_197 )
#177
...
incidence_list.append( V_160 )
F_ID = "F_175"
F_175 = onto.function( F_ID )
F_175.is_function_of = incidence_list
V_181.has_function.append( F_175 )
incidence_list = []
...
V_181.has_function.append( F_176 )
#182
...
V_182.has_function.append( F_178 )
incidence_list = []
...
V_182.has_function.append( F_195 )
#183
...
V_183.has_function.append( F_179 )
#185
...
V_185.has_function.append( F_181 )
#187
...
incidence_list.append( V_173 )
F_ID = "F_198"
F_198 = onto.function( F_ID )
F_198.is_function_of = incidence_list
V_187.has_function.append( F_198 )
#188
...
incidence_list.append( V_108 )
F_ID = "F_199"
F_199 = onto.function( F_ID )
F_199.is_function_of = incidence_list
V_192.has_function.append( F_199 )
#193
...
incidence_list.append( V_160 )
F_ID = "F_200"
F_200 = onto.function( F_ID )
F_200.is_function_of = incidence_list
V_193.has_function.append( F_200 )
#194
...
incidence_list.append( V_187 )
F_ID = "F_201"
F_201 = onto.function( F_ID )
F_201.is_function_of = incidence_list
V_194.has_function.append( F_201 )
#195
...
F_ID = "F_202"
F_202 = onto.function( F_ID )
F_202.is_function_of = incidence_list
V_195.has_function.append( F_202 )
