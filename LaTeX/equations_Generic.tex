...
\hyperlink{"v:166"}{ 162 }\hypertarget{"e:162"}{  } &
    ...
    \begin{lay}macroscopic\end{lay} \\
\hyperlink{"v:171"}{ 166 }\hypertarget{"e:166"}{  } &
    \begin{eq}{ElecPotential}{_{N}} := \left( {U}{_{N}} \right)^{-1} \, . \, {Charge}{_{}}\end{eq} &
    \begin{lay}electrical potential in volts\end{lay} &
    \begin{lay}physical\end{lay} \\
\hyperlink{"v:172"}{ 167 }\hypertarget{"e:167"}{  } &
    \begin{eq}{current}{_{}} := \TotDiff{{Charge}{_{}}}{{t}{_{}}}\end{eq} &
    \begin{lay}electrical current\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
\hyperlink{"v:173"}{ 168 }\hypertarget{"e:168"}{  } &
    \begin{eq}{elecResistance}{_{N}} := \left( {ElecPotential}{_{N}} \right)^{-1} \, . \, {current}{_{}}\end{eq} &
    \begin{lay}electrical resistance\end{lay} &
    \begin{lay}material\end{lay} \\
\hyperlink{"v:176"}{ 169 }\hypertarget{"e:169"}{  } &
    \begin{eq}{elecConductivityFrac}{_{N}} := \left( {elecResistance}{_{N}} \right)^{-1} \, . \, {additiveFraction}{_{N}}\end{eq} &
    \begin{lay}electrical conductivity as function of additive\end{lay} &
    \begin{lay}material\end{lay} \\
\hline
\end{longtable}