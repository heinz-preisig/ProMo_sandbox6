...
\hyperlink{"v:160"}{ 156 }\hypertarget{"e:156"}{  } &
    ...
    \begin{lay}physical\end{lay} \\
\hyperlink{"v:162"}{ 157 }\hypertarget{"e:157"}{  } &
    \begin{eq}{\hat{I}}{_{A}} := {P}{_{N, A}} \stackrel{N}{\,\star\,} \TotDiff{{C}{_{N}}}{{t}{_{}}}\end{eq} &
    \begin{lay}current definition\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
\hyperlink{"v:163"}{ 158 }\hypertarget{"e:158"}{  } &
    \begin{eq}{k_{C}}{_{A}} := {D}{_{N, A}} \stackrel{N}{\,\star\,} \left( {Ue}{_{N}} \right)^{-1} \, . \, {\hat{I}}{_{A}}\end{eq} &
    \begin{lay}electrical conductivity\end{lay} &
    \begin{lay}material\end{lay} \\
\hyperlink{"v:162"}{ 159 }\hypertarget{"e:159"}{  } &
    \begin{eq}{\hat{I}}{_{A}} := {k_{C}}{_{A}} \, . \, {D}{_{N, A}} \stackrel{N}{\,\star\,} {Ue}{_{N}}\end{eq} &
    \begin{lay}current definition\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
\hyperlink{"v:163"}{ 160 }\hypertarget{"e:160"}{  } &
    \begin{eq}{k_{C}}{_{A}} := \text{Instantiate}({k_{C}}{_{A}}, {\#}{_{}})\end{eq} &
    \begin{lay}electrical conductivity\end{lay} &
    \begin{lay}material\end{lay} \\
...
\hyperlink{"v:166"}{ 162 }\hypertarget{"e:162"}{  } &
    ...
    \begin{lay}macroscopic\end{lay} \\
\hyperlink{"v:169"}{ 164 }\hypertarget{"e:164"}{  } &
    \begin{eq}{k^{e}}{_{A}} := \left( \left( {k_{C}}{_{A}} \right)^{-1} \, . \, \left({P}{_{A, {N S}}} \stackrel{{N S}}{\,\star\,} ln({\xi}{_{{N S}}})\right) \right)^{-1}\end{eq} &
    \begin{lay}resistance as a very simple function of the mole fraction\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
\hyperlink{"v:162"}{ 165 }\hypertarget{"e:165"}{  } &
    \begin{eq}{\hat{I}}{_{A}} := {k^{e}}{_{A}} \, . \, \left({D}{_{N, A}} \stackrel{N}{\,\star\,} {Ue}{_{N}}\right)\end{eq} &
    \begin{lay}current definition\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
\hyperlink{"v:169"}{ 166 }\hypertarget{"e:166"}{  } &
    \begin{eq}{k^{e}}{_{A}} := \text{Instantiate}({k^{e}}{_{A}}, {\#}{_{}})\end{eq} &
    \begin{lay}resistance\end{lay} &
    \begin{lay}macroscopic\end{lay} \\
\hline
\end{longtable}